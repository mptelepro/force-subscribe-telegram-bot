...
class Config():
  ...
  if ENV:
    ...
    DATABASE_URL = os.environ.get("mongodb+srv://Filterjinnv2hn:Filterjinnv2hn@cluster0.i1rfo.mongodb.net/myFirstDatabase?retryWrites=true&w=majority", None)
    ...
    DATABASE_URL = "mongodb+srv://Filterjinnv2hn:Filterjinnv2hn@cluster0.i1rfo.mongodb.net/myFirstDatabase?retryWrites=true&w=majority"
    APP_ID = "2443183"
